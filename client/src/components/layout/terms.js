...
export default () => {
  return (
    <div>
      ...
      <p>Last updated: July 10, 2018</p>

      <p>
        Please read these Terms and Conditions ("Terms", "Terms and Conditions")
        carefully before using the https://riidlfbproject.herokuapp.com/ website
        (the "Service") operated by riidlfbproject ("us", "we", or "our").
      </p>
      ...
      <p>
        ...
        Service. This Terms and Conditions agreement for riidlfbproject is{" "}
      ...
      <p>
        ...
        are not owned or controlled by riidlfbproject.
      </p>

      <p>
        riidlfbproject has no control over, and assumes no responsibility for,
        the content, privacy policies, or practices of any third party web sites
        or services. You further acknowledge and agree that riidlfbproject shall
      ...
      <p>
        ...
        of Maharashtra, India, without regard to its conflict of law provisions.
      </p>
