...
export default () => {
  return (
    <div>
      ...
      <p>Effective date: July 10, 2018</p>

      <p>
        riidlfbproject ("us", "we", or "our") operates the
        https://riidlfbproject.herokuapp.com/ website and the riidlfbproject
      ...
      <p>
        ...
        have associated with that data. This Privacy Policy for riidlfbproject
        is
      ...
      <p>riidlfbproject uses the collected data for various purposes:</p>
      <ul>
      ...
      <p>
        riidlfbproject will take all steps reasonably necessary to ensure that
      ...
      <p>
        riidlfbproject may disclose your Personal Data in the good faith belief
        that such action is necessary to:
      </p>
      <ul>
        <li>To comply with a legal obligation</li>
        <li>To protect and defend the rights or property of riidlfbproject</li>
        <li>
      ...
      <ul>
        <li>By email: menger999@gmail.com</li>
      </ul>
    </div>
  );
};
